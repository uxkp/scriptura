  ...
  return (
    <div className="flex min-h-screen min-w-screen bg-[#19191C]">
      <section className="bg-[#19191C] hidden md:block border-r-2 border-r-[#232325] relative shadow-2xl max-w-[35vw] overflow-hidden p-10 z-1000">
        ...
        <div className="mt-10">
          <h1
            className={`${handwritten.className} text-7xl bg-linear-to-r from-[#D6C7FF] to-[#602be8] bg-clip-text text-transparent`}
          >
            Scriptura
          </h1>
          <div className="space-y-5 text-[#fff]">
            <h1 className="mt-[30px] text-[30px] leading-[42px] max-w-100 font-semibold">
              Read and write informative blogs.
            </h1>
