...
export function AlertProvider({ children }) {
  ...
  return (
    <AlertContext.Provider value={{ message, showAlert, clearAlert }}>
      ...
      {message && (
        <div className="fixed bottom-4 flex items-center gap-3 left-1/2 whitespace-nowrap -translate-x-1/2 bg-[#0d2a1f] text-green-300 px-5 py-3 rounded-xl text-base shadow-2xl z-50000">
